...
type Span struct {
	...
	Metrics   map[string]*Numeric `protobuf:"bytes,7,rep,name=Metrics,proto3" json:"Metrics,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Status    SpanStatus          `protobuf:"varint,8,opt,name=Status,proto3,enum=universal.opentracing.transformer.SpanStatus" json:"Status,omitempty"`
...
var file_span_proto_rawDesc = []byte{
	...
	0x07, 0x4e, 0x75, 0x6d, 0x65, 0x72, 0x69, 0x63, 0x22, 0xb3, 0x04, 0x0a, 0x04, 0x53, 0x70, 0x61,
	0x6e, 0x12, 0x18, 0x0a, 0x07, 0x54, 0x72, 0x61, 0x63, 0x65, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x54, 0x72, 0x61, 0x63, 0x65, 0x49, 0x44, 0x12, 0x1a, 0x0a, 0x08, 0x50,
	...
	0x44, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x53, 0x70, 0x61, 0x6e, 0x49, 0x44, 0x12,
	...
	0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x75, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x61,
	...
	0x0a, 0x07, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2d,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x72, 0x74, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x53, 0x74, 0x61, 0x72, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x45,
	0x6e, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x45, 0x6e, 0x64, 0x1a, 0x37, 0x0a,
	...
	0x02, 0x12, 0x09, 0x0a, 0x05, 0x43, 0x72, 0x61, 0x73, 0x68, 0x10, 0x03, 0x42, 0x45, 0x5a, 0x43,
...
var file_span_proto_goTypes = []interface{}{
	...
	(*Numeric)(nil), // 1: universal.opentracing.transformer.Numeric
	(*Span)(nil),    // 2: universal.opentracing.transformer.Span
	(*Trace)(nil),   // 3: universal.opentracing.transformer.Trace
	(*Traces)(nil),  // 4: universal.opentracing.transformer.Traces
	nil,             // 5: universal.opentracing.transformer.Span.MetaEntry
	nil,             // 6: universal.opentracing.transformer.Span.MetricsEntry
}
var file_span_proto_depIdxs = []int32{
	5, // 0: universal.opentracing.transformer.Span.Meta:type_name -> universal.opentracing.transformer.Span.MetaEntry
	6, // 1: universal.opentracing.transformer.Span.Metrics:type_name -> universal.opentracing.transformer.Span.MetricsEntry
	0, // 2: universal.opentracing.transformer.Span.Status:type_name -> universal.opentracing.transformer.SpanStatus
	2, // 3: universal.opentracing.transformer.Trace.Trace:type_name -> universal.opentracing.transformer.Span
	3, // 4: universal.opentracing.transformer.Traces.Traces:type_name -> universal.opentracing.transformer.Trace
	1, // 5: universal.opentracing.transformer.Span.MetricsEntry.value:type_name -> universal.opentracing.transformer.Numeric
